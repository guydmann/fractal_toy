...
def setup_fractal(args):
    fractal = None
    if args.fractal_algorithm == "mandelbrot":
        fractal = Mandelbrot()
    elif args.fractal_algorithm == "julia":
        fractal = Julia()
    elif args.fractal_algorithm == "burning_ship":
        fractal = BurningShip()
    elif args.fractal_algorithm == "star":
        fractal = Star()
    elif args.fractal_algorithm == "newton":
        fractal = Newton()
    elif args.fractal_algorithm == "phoenix_mandelbrot":
        fractal = PhoenixMandelbrot()
    elif args.fractal_algorithm == "phoenix_julia":
        fractal = PhoenixJulia()
    elif args.fractal_algorithm == "cubic_mandelbrot":
        fractal = CubicMandelbrot()
    elif args.fractal_algorithm == "cubic_julia":
        fractal = CubicJulia()
    elif args.fractal_algorithm == "quartic_mandelbrot":
        fractal = QuarticMandelbrot()
    elif args.fractal_algorithm == "quartic_julia":
        fractal = QuarticJulia()
    elif args.fractal_algorithm == "experimental_cubic_julia":
        fractal = ExperimentalCubicJulia()
    elif args.fractal_algorithm == "buddhabrot":
        fractal = Buddhabrot()
    elif args.fractal_algorithm == "buddhabrot_julia":
